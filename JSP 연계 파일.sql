...
select country.Continent, count(countrylanguage.CountryCode) from countrylanguage inner join country on country.Code = countrylanguage.CountryCode where countrylanguage.Language = 'English' group by country.Continent;
